    ...
    return (
        <MainLayout title="Discover Galleries">
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50">Discover Galleries</h1>
                    <p className="mt-2 text-zinc-600 dark:text-zinc-400">Find the perfect space for your exhibition</p>
                </div>
                ...
                {galleries.data.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                        <p className="text-zinc-500 dark:text-zinc-400">No galleries found</p>
                    </div>
                )}
