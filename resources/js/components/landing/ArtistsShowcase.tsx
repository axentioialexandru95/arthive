...
export function ArtistsShowcase({ artists }: ArtistsShowcaseProps) {
    ...
    return (
        <section className="container mx-auto px-4 py-20">
            ...
            <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerContainer} className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {artists.map((artist) => (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.3 }} className="mt-12 text-center">
